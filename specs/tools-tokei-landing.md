...
- **構成**: ヒーロー → 特徴3つ → 難しさ5段階 → 使い方3ステップ → FAQ → CTA
...
- **手動確認観点**: みじかい はり／ながい はり（針1本ずつ）・ちょうどの じかん・30ぷんきざみ・5ふんきざみ・1ぷんきざみ の5段階が明記され、アプリCTAが `/tools/tokei/` へ向いていること。
  FAQ の `<details>` と JSON-LD の FAQPage が同じ設問・同じ本文であること（片方だけ足すのを防ぐ）
