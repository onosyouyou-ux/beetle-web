...
- **構成**: ヒーロー → 4つの修行（どっちで かく／カタカナに なおす／にた字 みつけ／カタカナを かく）→ カタカナで書く4つのルール → 使い方3ステップ → FAQ → CTA
- **アプリのモードを増やしたら、ここの修行カード・使い方・FAQ・JSON-LD の4か所を同時に直す**
  （2026-09-14に「カタカナを かく」を足したとき、ランディングが「3つの修行」のまま取り残された。2026-09-15修正）
